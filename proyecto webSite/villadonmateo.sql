...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2022 at 02:18 AM
...
CREATE TABLE `documento` (
  ...
  `nombreDocumentoRetiro` varchar(250) DEFAULT NULL,
  `folioDocumento` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `integrante_hogar` (
  ...
  `estadoIntHogar` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
